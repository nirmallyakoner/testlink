...
export function LoginContent() {
  ...
  async function handleGoogleSignIn() {
    ...
    const { error: oauthError } = await supabase.auth.signInWithOAuth({
      provider: "google",
      options: {
        redirectTo: `${window.location.origin}/auth/callback?role=educator`,
        queryParams: {
          access_type: "offline",
          prompt: "consent",
        },
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 relative">
      {/* Background glow */}
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[300px] bg-primary/6 rounded-full blur-[100px] pointer-events-none" />
      ...
      >
        ...
        <div className="bg-surface border border-border rounded-2xl p-8">
          ...
          <p className="text-sm text-text-secondary mb-8 text-center">
            Sign in to create and manage your tests
          </p>
